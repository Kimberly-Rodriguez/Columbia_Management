...
// isEqualTakeTwo('10',10);
// isEqualTakeTwo(9 , true);

// //function declaration

// function myName(firstName, lastName ){
// console.log("Her fullname is " + firstName + ' ' + lastName);
// return;
// };

// myName('Kimberly', 'Rodriguez')

// //function expression

// let myTitle = function(office, title) {
//   console.log("She worked in the office of " + office + " " + 'as the ' + title + ' at the city of Los Angeles!');
//   return;
// };

// myTitle('Budget and Innovation', 'Data Programs Lead')
...
// let shadow = "hello";
// console.log("lets make this be " + shadow);
...
// let returnValue = sayWhatAgain();
// console.log("it worked! " + returnValue);
...
// function byeByeBye() {
//   let adios = "bye bye now!"
//   return adios;
// }

// let newSharedVariable = byeByeBye()
// console.log(newSharedVariable);

// byeByeBye();


const makePortfolios = function() {
  let count = 0;
  const portfolios = [];
  while (count < 10) {
      const portfolio = function() {
          return { name: 'Portfolio # ' + count };
      };
...
const portfolios = makePortfolios();
const number0 = portfolios[0];
console.log(number0.name);
const number8 = portfolios[8];
console.log(number8.name);
